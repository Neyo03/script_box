...
<button onclick="quitForm()">X</button>
    ...
    <div class="blocConnexion">
        <form action="/script_box/utilisateur/connexion" method="post">  
            <label for="pseudo">Pseudo</label><input type="text" placeholder="Pseudo / Email" name="pseudo" value="<?= ($_POST['pseudo'] ?? '' ) ?>" id="">
            <label for="password">Mot de passe</label><input type="password"  placeholder="Mot de passe" name="mdp" id="">
